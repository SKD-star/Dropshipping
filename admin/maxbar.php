...
<?php
    echo '<h2>Blog Paragraphs</h2>
        <ul id="sortable" class="max">';
    $query = "SELECT * FROM pages where position='maxbar' order by funord asc";
    ...
    echo '</ul>
        <button id="save" class="btn btn-primary mt-3 apgbt">Save Order</button>';
?>
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.bundle.min.js"></script>
<script>
    document.querySelectorAll('.max').forEach((sortable) => {
